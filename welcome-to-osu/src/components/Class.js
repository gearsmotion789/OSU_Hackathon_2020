    ...
    <div className = "app">
        <div>
          ...
          <div className = "classProcess">
            ...
            <div className = "classLeftInstruction">Log into the </div>
            <a class='myOSULink' href="https://myosu.oregonstate.edu/" target="_blank">MyOSU</a>
            <div className = "classLeftInstruction">portal and click on the Student tab.</div>
            ...
            <div className = "classSnstruction">When done adding all your courses and breaks, scroll down and click Generate Schedules.</div>
